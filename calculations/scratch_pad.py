...
print("-----------------------------------------------------------------------------------------------------")
power_set = Summations.get_power_collection([12,18,25])
print(power_set)
...
print("Furniture Monetary Offers can often range from " + str(furniture_ev_v2 - standard_deviation) + " to " + str(furniture_ev_v2 + standard_deviation))
print("-----------------------------------------------------------------------------------------------------")
print("Getting other Total Variances")
print("-----------------------------------------------------------------------------------------------------")
furniture_ev_v2 = Summations.get_total_expectation(27,[12,18,25],13)
total_variance_furniture = Summations.get_total_variance(27,[12,18,25],13)
standard_deviation_furniture = math.sqrt(total_variance_furniture)
coefficient_variation_furniture = standard_deviation_furniture / furniture_ev_v2
print("furniture ev: " + str(furniture_ev_v2))
print("furniture standard deviation: " + str(standard_deviation_furniture))
print("furniture coefficient of variation: " + str(coefficient_variation_furniture))
print("-----------------------------------------------------------------------------------------------------")
art_ev_v2 = Summations.get_total_expectation(27,[5, 9, 13, 18],13)
total_variance_art = Summations.get_total_variance(27,[5, 9, 13, 18],13)
standard_deviation_art = math.sqrt(total_variance_art)
coefficient_variation_art = standard_deviation_art / art_ev_v2
print("art ev: " + str(art_ev_v2))
print("art standard deviation: " + str(standard_deviation_art))
print("art coefficient of variation: " + str(coefficient_variation_art))
print("-----------------------------------------------------------------------------------------------------")
kitchen_ev_v2 = Summations.get_total_expectation(27,[2, 3, 4, 5, 7],13)
total_variance_kitchen = Summations.get_total_variance(27,[2, 3, 4, 5, 7],13)
standard_deviation_kitchen = math.sqrt(total_variance_kitchen)
coefficient_variation_kitchen = standard_deviation_kitchen / kitchen_ev_v2
print("kitchen ev: " + str(kitchen_ev_v2))
print("kitchen standard deviation: " + str(standard_deviation_kitchen))
print("kitchen coefficient of variation: " + str(coefficient_variation_kitchen))
print("-----------------------------------------------------------------------------------------------------")
print("specify ev and standard deviation first")
print("then make customers that fit with in it")
print("use it to make a fairness metric")
print("something like \"for every additional dollar in ev, there should be 20 cents more in standard deviation\"")